...
class PLF_CoolMultipleSelect extends PLF_MultipleSelectionElement
{
  ...
  public function PLF_CoolMultipleSelect($name, $label, $values, $size, $required) {
  ...
  function render($tabIndex) {
    $toReturn = ' <select multiple id="'.$this->getName().'" size="'.$this->size.'" tabindex="'.$tabIndex.'" name="'.$this->getName().'[] '.$this->attribute.' >';
