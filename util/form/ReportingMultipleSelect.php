...
class PLF_ReportingMultipleSelect extends PLF_MultipleSelectionElement
{
  ...
  function render($tabIndex) {
    $toReturn = ' <select multiple id="'.$this->getName().'" size="'.$this->size.'" tabindex="'.$tabIndex.'" name="'.$this->getName().'[]" onChange="selectMultipleChanged(\''.$this->getName().'\');" '.$this->attribute.' >';
