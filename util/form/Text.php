...
class PLF_Text extends PLF_Element
{
  ...
  public function PLF_Text($name, $label, $size, $maxlength, $required) {
  ...
  function render($tabIndex) {
    $toReturn =' <input type="text" tabindex="'.$tabIndex.'" name="'.$this->getName().'" id="'.$this->getName().'" size="'.$this->size.'" maxlength="'.$this->maxlength.'"';
